...
- [ ] 159\. Parallel scheduler — до 10 исполнителей без коллизий
...
- [ ] 160\. Красный CI — hard stop, заморозка, retry
...
- [ ] 161\. Контроллёры и Исследователи — per-role провайдер (А-24)
...
- [ ] 162\. Полное восстановление с диска (Шаг 0) + gate-only VRAM-аудит
...
- [ ] 170\. Driver survives a stack restart landing inside a model call (платформа; находка M15а §4.1)
...
- [ ] 171\. Walk bookkeeping scoped by project (находка M15а §4.1, побочная)
...
- [ ] 172\. Intake idempotent over prose + живое умолчание модели заданий (вердикты §7.1/§7.2 рапорта M15а, А-25)
...
- [ ] 173\. Loop e2e в CI + общий словарь ожидаемого консольного шума (вердикты §7.5/§6.1 рапорта M15а, А-25)
