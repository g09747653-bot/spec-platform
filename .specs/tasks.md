...
- [ ] 175\. Адаптер подписки штатно — `claude-cli` звено (вердикт §7.1 рапорта M16а)
...
- [ ] 176\. Причина красноты — исполнителю; POSIX-команды — в инструкцию (находки §6 рапорта M16а)
