...
_Снимки, дамп рестарта и лог dev-сервера этой прогулки в репозиторий не положены: три прогона одной
и той же прогулки различаются только тем, что все три зелёные, и это видно из вердикта выше. Полный
комплект артефактов лежит у первой прогулки (`walk-1/`)._
